...
import { EffectIcon, MessageIcon, BoxIcon } from '../../../components/Icons';
...
function Header() {
  ...
  const [currentUser, setCurrentUser] = useState({
    ...
    name: 'Lucy',
    username: 'lucyonfire',
    avatar: 'https://yt3.ggpht.com/yti/AHXOFjVgrq6z0ujBi4smbJCBs4EpsPc45q1KCTNqr4CSdA=s108-c-k-c0x00ffffff-no-rj',
  });
          ...
          {currentUser ? (
            <>
              <Tippy content="Upload" placement="bottom">
                <Button to="/upload" outlineBlack className={cx('action-btn')}>
                  <FontAwesomeIcon icon={faPlus} />
                  Upload
                </Button>
              </Tippy>

              <Tippy content="Effect" placement="bottom">
          ...
          <Menu items={currentUser ? userMenu : MENU_ITEM} onChange={handleMenuChange}>
            {currentUser ? (
              <Image
                ...
                fallBack="https://yt3.ggpht.com/eOyke7ccBBUTD2cfoTWsNYVy55iSiBBINBvJA8C9DGLqSug7HV3xYuaiaJ0mCtpT1Vy3s9P49Dg=s48-c-k-c0x00ffffff-no-nd-rj"
              ></Image>
            ) : (
